...
const it = {
  ...
  newsletter: {
    ...
    bottoneIscrizione: "Ricevi il mio -10%",
    rassicurazione: "Un'email, un codice, nessun impegno.",
  ...
  emailNewsletter: {
    ...
    firma: "A presto,",
    disiscrizioneTesto: "Non vuoi più ricevere questi messaggi? ",
    disiscrizioneLink: "Disiscriviti",
  },
  paginaDisiscrizione: {
    titolo: "Disiscrizione dalla newsletter",
    descrizione: "Annulla la tua iscrizione alla newsletter di Vizio Bistrot.",
    heroOcchiello: "Newsletter",
    heroTitolo: "Disiscrizione",
    heroSottotitolo: "Un solo passaggio, nessun accesso richiesto.",

    fattoTitolo: "Iscrizione annullata",
    fattoTesto: "Non riceverai più email dalla nostra newsletter. Il codice sconto già ricevuto resta valido fino alla sua scadenza o al suo utilizzo.",
    giaFattoTitolo: "Sei già disiscritto/a",
    giaFattoTesto: "Questo indirizzo non è più iscritto alla newsletter: nessuna nuova azione necessaria.",
    linkNonValidoTitolo: "Link non valido",
    linkNonValidoTesto: "Questo link non è valido, o non corrisponde a nessuna iscrizione attiva.",
    erroreTitolo: "Qualcosa non ha funzionato",
    erroreTesto: "Non siamo riusciti a completare la richiesta. Riprova più tardi, o scrivici.",
...
const en: Dizionario = {
  ...
  newsletter: {
    ...
    bottoneIscrizione: "Get my -10%",
    rassicurazione: "One email, one code, no commitment.",
    invio: "Signing up…",
  ...
  emailNewsletter: {
    ...
    firma: "See you soon,",
    disiscrizioneTesto: "Don't want these emails any more? ",
    disiscrizioneLink: "Unsubscribe",
  },
  paginaDisiscrizione: {
    titolo: "Newsletter unsubscribe",
    descrizione: "Cancel your subscription to the Vizio Bistrot newsletter.",
    heroOcchiello: "Newsletter",
    heroTitolo: "Unsubscribe",
    heroSottotitolo: "One step, no sign-in required.",

    fattoTitolo: "You're unsubscribed",
    fattoTesto: "You won't receive any more emails from our newsletter. Any discount code you already received stays valid until it expires or is used.",
    giaFattoTitolo: "You're already unsubscribed",
    giaFattoTesto: "This address is no longer subscribed to the newsletter: no further action needed.",
    linkNonValidoTitolo: "Invalid link",
    linkNonValidoTesto: "This link isn't valid, or doesn't match any active subscription.",
    erroreTitolo: "Something didn't work",
    erroreTesto: "We couldn't complete the request. Try again later, or get in touch.",
